...
export interface SandCoastPlainModelProps {
  tiles: TileType[];
}

export const SandCoastPlainModel = ({ tiles }: SandCoastPlainModelProps) => {
  const { state } = useEnvironmentContext();
  const { nodes, materials } = state.models[TerrainTypeEnum.SAND_COAST];
